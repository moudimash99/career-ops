...
user_invocable: true
user-invocable: true
argument-hint: "[scan | scan-defense | discover | deep | pdf | text | latex | latex-tex | cover | email | add | expand | eu-swe | oferta | ofertas | apply | apply-freemotion | batch | tracker | agent-inbox | pipeline | contacto | training | project | interview-prep | interview | interview/plan | interview/practice | interview/debrief | interview-redflag | patterns | offer-prep | titles | upskill | followup | reply-watch | outcome | update]"
license: MIT
---
...
| `pipeline` | `pipeline` |
| `apply` | `apply` |
| `apply-freemotion` | `apply-freemotion` |
| `scan` | `scan` |
| `discover` | `discover` |
| `batch` | `batch` |
| `patterns` | `patterns` |
