...
<p align="center">
  Unternehmen nutzen KI, um Bewerber:innen zu filtern. <strong>Ich habe Bewerber:innen KI gegeben, um Unternehmen zu <em>bewerten</em>.</strong>
</p>
...
<p align="center">
  <a href="HIRED.md"><img src="docs/hired-wall.svg" alt="Einstellungsgeschichten, die du öffnen und lesen kannst" width="800"></a>
</p>
...
Füge eine Stelle ein, auf die du dich heute Abend bewerben wolltest. Kommt <em>nicht bewerben</em> zurück, hast du gerade den Abend zurückgewonnen. Kommt ein Plan zurück, weißt du, was als Nächstes zu tun ist.

```bash
npx @santifer/career-ops init
```

<p align="center"><sub>Open Source. Lokal. In der KI-CLI, die du schon nutzt. <a href="docs/RUNNING_ON_A_BUDGET.md">Kostenlose und lokale Modelle inklusive.</a></sub></p>


## Du musst nicht allein suchen

Die Stille nach dem Absenden hat nichts mit dir zu tun. Genug Leute haben dasselbe gesehen, um die Praxis aufzuschreiben, in sechs Zeilen:

> Besser bewerben, bei weniger. Signal statt Masse. Belege statt Schlagwörter. Ein Mensch entscheidet. Local-first. Würde auf beiden Seiten des Tisches.

<p align="center"><a href="https://career-ops.org/manifesto?utm_source=readme"><img src="https://img.shields.io/badge/dynamic/regex?url=https%3A%2F%2Fraw.githubusercontent.com%2Fcareer-ops-hq%2Fcareer-ops%2Fmain%2FSIGNATURES.md&search=n%3A(%5Cd%2B)%5Cs*%24&replace=%241%20signatories&label=THE%20CAREEROPS%20MANIFESTO&color=DD7627&style=for-the-badge&labelColor=2b3137" alt="Das CareerOps-Manifest: Zahl der Unterzeichner, live"></a></p>

<p align="center">Ein paar von ihnen, in ihren eigenen Worten.</p>

<p align="center">
  <a href="https://career-ops.org/manifesto?utm_source=readme"><img src="docs/manifesto-wall.svg" alt="Drei Unterschriften unter dem CareerOps-Manifest, in eigenen Worten" width="800"></a>
</p>

<p align="center"><sub>Jede Unterschrift ist ein Commit, den du prüfen kannst. <a href="https://career-ops.org/manifesto?utm_source=readme">Alle lesen, oder deine hinzufügen →</a></sub></p>

<br>

Das Recruiting repariert sich nicht von selbst. Die Leute, die es durchmachen, können das, und sie sind schon im Raum, tauschen Notizen aus und reparieren sich gegenseitig die Setups. [Hier wird die Lösung geschrieben](CONTRIBUTING.md). Ein Raum, kein Club. **Lasst uns gemeinsam bauen.**

<p align="center"><a href="https://discord.gg/8pRpHETxa4"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdiscord.com%2Fapi%2Fv10%2Finvites%2F8pRpHETxa4%3Fwith_counts%3Dtrue&query=%24.approximate_member_count&label=Discord&suffix=%20members&color=5865F2&style=for-the-badge&labelColor=2b3137&logo=discord&logoColor=white" alt="Discord: Mitgliederzahl des career-ops-Servers, live"></a></p>
...
> Sponsoring kauft klar gekennzeichnete Sichtbarkeit, nie Einfluss: kein Geldbetrag ändert die Roadmap oder platziert etwas im Produkt. Sponsoren erscheinen nie in Bewertungen, Rankings oder Empfehlungen.

## Was career-ops für dich tut
...
- **Wo landet das alles?** Jede Bewerbung bleibt auf deinem Rechner. Zu uns wird nichts hochgeladen.
- **Was sollte ich lernen?** Nach einer Serie von Absagen benennt es die Lücke.

Die ersten Durchläufe sind holprig. Es kennt dich noch nicht. Sprich mit ihm: dein Lebenslauf, was du willst, was du ablehnst. Stell es dir wie die erste Woche eines Recruiters vor.

Beim ersten Start fragt es das alles im Chat ab. Nichts von Hand zu konfigurieren.
...
| **Bewerbungs-E-Mail-Entwürfe** | Formelle E-Mails an Recruiter:innen, für Empfehlungen oder Initiativbewerbungen aus einem Report oder einer eingefügten Stellenbeschreibung, mit Betreff, Anhang-Checkliste, belegten Fit-Punkten und einem Kontaktblock aus deinem Profil. Nur Entwürfe. |
...
/career-ops email     → Formeller Bewerbungs-E-Mail-Entwurf (nur Entwurf)
...
<p align="center">
  <sub>Läuft auch in jeder CLI mit dem Agent-Skill-Standard. Siehe <a href="docs/SUPPORTED_CLIS.md">Unterstützte CLIs</a>.</sub><br>
...
2. **Du hältst dich an die AGB Dritter.** Du musst dieses Tool im Einklang mit den Nutzungsbedingungen der Karriereportale verwenden, mit denen du interagierst (Greenhouse, Lever, Workday, LinkedIn usw.). Nutze dieses Tool nicht, um Arbeitgeber zu spammen oder ATS-Systeme zu überlasten.
3. **Keine Garantien.** Bewertungen sind Empfehlungen, keine Wahrheit. KI-Modelle können Kenntnisse oder Erfahrungen halluzinieren. Die Autor:innen haften nicht für Beschäftigungsergebnisse, abgelehnte Bewerbungen, Kontosperren oder andere Folgen.
